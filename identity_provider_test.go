...
func (test *IdentityProviderTest) TestMarshalAssertion(c *C) {
	...
	expectedPlaintext := "<Assertion xmlns=\"urn:oasis:names:tc:SAML:2.0:assertion\" ID=\"id-00020406080a0c0e10121416181a1c1e20222426\" IssueInstant=\"2015-12-01T01:57:09Z\" Version=\"2.0\"><Issuer Format=\"XXX\">https://idp.example.com/saml/metadata</Issuer><Subject><NameID Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:transient\" NameQualifier=\"https://idp.example.com/saml/metadata\" SPNameQualifier=\"https://sp.example.com/saml2/metadata\"/><SubjectConfirmation Method=\"urn:oasis:names:tc:SAML:2.0:cm:bearer\"><SubjectConfirmationData Address=\"\" InResponseTo=\"id-00020406080a0c0e10121416181a1c1e\" NotOnOrAfter=\"2015-12-01T01:58:39Z\" Recipient=\"https://sp.example.com/saml2/acs\"/></SubjectConfirmation></Subject><Conditions NotBefore=\"2015-12-01T01:57:09Z\" NotOnOrAfter=\"2015-12-01T01:58:39Z\"><AudienceRestriction><Audience>https://sp.example.com/saml2/metadata</Audience></AudienceRestriction></Conditions><AuthnStatement AuthnInstant=\"0001-01-01T00:00:00Z\" SessionIndex=\"\"><SubjectLocality Address=\"\"/><AuthnContext><AuthnContextClassRef>urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport</AuthnContextClassRef></AuthnContext></AuthnStatement><AttributeStatement><Attribute FriendlyName=\"uid\" Name=\"urn:oid:0.9.2342.19200300.100.1.1\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\"><AttributeValue xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"xs:string\">alice</AttributeValue></Attribute></AttributeStatement><ds:Signature xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:SignedInfo><ds:CanonicalizationMethod Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><ds:SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><ds:Reference URI=\"#id-00020406080a0c0e10121416181a1c1e20222426\"><ds:Transforms><ds:Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/><ds:Transform Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></ds:Transforms><ds:DigestMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><ds:DigestValue>uXNBKJoWgXBWfBBbuoSFavgodGY=</ds:DigestValue></ds:Reference></ds:SignedInfo><ds:SignatureValue>JRUgEvUIZNJzSneaDMNzGLXRJQTMAPRmeKurC79CQDr5YBWG1eCLbXCWcJbdy8V2ZXAyGvz2A/VsFSs6w4sZzm5FckcFs11vgfsULhYB+wuppZMGkW/jtpD8xWKhLI7zwwJ+TAnbmRmKGs1D+zJSW589NsnlFxQii/Uu89DzZO8=</ds:SignatureValue><ds:KeyInfo><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo></ds:Signature></Assertion>"
	actualPlaintext := ""
	{
	...
	c.Assert(err, IsNil)
	c.Assert(string(assertionBuffer), Equals, "<saml2:EncryptedAssertion xmlns:saml2=\"urn:oasis:names:tc:SAML:2.0:protocol\"><xenc:EncryptedData xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\" Id=\"_e285ece1511455780875d64ee2d3d0d0\" Type=\"http://www.w3.org/2001/04/xmlenc#Element\"><xenc:EncryptionMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#aes128-cbc\" xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\"/><ds:KeyInfo xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><xenc:EncryptedKey Id=\"_6e4ff95ff662a5eee82abdf44a2d0b75\" xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\"><xenc:EncryptionMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p\" xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\"><ds:DigestMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\" xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"/></xenc:EncryptionMethod><ds:KeyInfo><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo><xenc:CipherData xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\"><xenc:CipherValue>R9aHQv2U2ZZSuvRaL4/X8TXpm2/1so2IiOz/+NsAzEKoLAg8Sj87Nj5oMrYY2HF5DPQm/N/3+v6wOU9dX62spTzoSWocVzQU+GdTG2DiIIiAAvQwZo1FyUDKS1Fs5voWzgKvs8G43nj68147T96sXY9SyeUBBdhQtXRsEsmKiAs=</xenc:CipherValue></xenc:CipherData></xenc:EncryptedKey></ds:KeyInfo><xenc:CipherData xmlns:xenc=\"http://www.w3.org/2001/04/xmlenc#\"><xenc:CipherValue></xenc:CipherValue></xenc:CipherData></xenc:EncryptedData></saml2:EncryptedAssertion>")
}
...
func (test *IdentityProviderTest) TestCanHandleUnencryptedResponse(c *C) {
	...
	c.Assert(responseStr, DeepEquals, ""+
		...
		"    <StatusCode xmlns=\"urn:oasis:names:tc:SAML:2.0:protocol\" Value=\"urn:oasis:names:tc:SAML:2.0:status:Success\"/>\n"+
		"  </Status>\n"+
		"  <Assertion xmlns=\"urn:oasis:names:tc:SAML:2.0:assertion\" ID=\"id-00020406080a0c0e10121416181a1c1e20222426\" IssueInstant=\"2015-12-01T01:57:09Z\" Version=\"2.0\">\n"+
		"    <Issuer Format=\"XXX\">https://idp.example.com/saml/metadata</Issuer>\n"+
		"    <Subject>\n"+
		...
		"        <SubjectConfirmationData Address=\"\" InResponseTo=\"id-00020406080a0c0e10121416181a1c1e\" NotOnOrAfter=\"2015-12-01T01:58:39Z\" Recipient=\"https://gitlab.example.com/users/auth/saml/callback\"/>\n"+
		"      </SubjectConfirmation>\n"+
		"    </Subject>\n"+
		...
		"        <AttributeValue xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"xs:string\">alice</AttributeValue>\n"+
		"      </Attribute>\n"+
		"    </AttributeStatement>\n"+
		...
		"          <ds:DigestValue>1Hn/ZGHqK2uWQgsx7tEV9HVTic0=</ds:DigestValue>\n"+
		"        </ds:Reference>\n"+
		"      </ds:SignedInfo>\n"+
		"      <ds:SignatureValue>LJmHvCeJeczXNEXCK5QcmhPUwpdv5IzLNyA7JYK/HjVbet3Rfq7l0JEeqaPuGuksEFXHx9lfcXt2mClTDB3x/RoByIvopP/2bkN+LZ5ce3RuRyleIz0UazTnU4NCy2Xr46FGGOV+R0nHuFDp3wr6bShAURFzEeluaAguWFva/Xg=</ds:SignatureValue>\n"+
		"      <ds:KeyInfo>\n"+
		"        <ds:X509Data>\n"+
